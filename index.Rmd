...
average delay between crime occurence to report filed in days (from 2008 - present). Insert insights.
...
average delay between crime occurence to report filed in days (from 2008 - present). This unveils the correlation between crime types (i.e. assault, etc.)
...
<<<<<<< HEAD
#most_pop_crime(seattle_data)
=======
most_pop_crime(seattle_data_two)
>>>>>>> 1d33a284a61a1308efd676b2f86fe46a007c063c
```
